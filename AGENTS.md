...
- IMPORTANT: Build the code with Scripts/buildapp to ensure it builds successfully; review build logs in Logs/build_logs.txt and fix the errors if there are any.
