...
// MARK: - Darkening Card Button Style

// Custom button style that provides a subtle scale effect on press.
// Used by card buttons to give tactile feedback without default button highlighting.
