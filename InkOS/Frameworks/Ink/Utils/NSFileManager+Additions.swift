...
extension FileManager {
  ...
  func cachesDirectory() -> String {
    let paths: [String] = NSSearchPathForDirectoriesInDomains(
      SearchPathDirectory.cachesDirectory, SearchPathDomainMask.userDomainMask, true)
    return paths.first ?? ""
  }
  ...
  func documentDirectoryPath() -> String {
    let paths: [String] = NSSearchPathForDirectoriesInDomains(
      SearchPathDirectory.documentDirectory, SearchPathDomainMask.userDomainMask, true)
    return paths.first ?? ""
  }
  ...
  func libraryDirectory() -> String {
    let paths: [String] = NSSearchPathForDirectoriesInDomains(
      SearchPathDirectory.libraryDirectory, SearchPathDomainMask.userDomainMask, true)
    return paths.first ?? ""
  }
