...
class FilesViewModel {
  ...
  func loadData() {
    let openBarButtonItem: UIBarButtonItem = UIBarButtonItem(
      title: "Open", style: .plain, target: self, action: #selector(open))
    ...
    self.model = FilesModel(
      files: fileModels, openBarButtonItem: openBarButtonItem,
