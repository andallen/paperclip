...
extension Storyboarded where Self: PartTypesTableViewController {
  static func instantiate(viewModel: PartTypesViewModel, coordinator: MainCoordinator)
...
extension Storyboarded where Self: ExportTableViewController {
  static func instantiate(viewModel: ExportViewModel, coordinator: MainCoordinator)
    -> UINavigationController?
  {
    guard let vc = instantiate(from: .main) else {
      return nil
