...
struct AlertModelHelper {
  ...
  static func createAlertModel(with error: ToolingWorker.ToolingError) -> AlertModel {
    ...
    case .setToolFailed, .noPartType:
      ...
      return self.createDefaultErrorAlert(
        message: "An error occurred during the tool selection",
        exitAppWhenClosed: false)
    case .lassoNotSupported:
      return self.createDefaultErrorAlert(
        message: "The lasso is not supported for this page type",
        exitAppWhenClosed: false)
    case .setToolStyleFailed:
      print("An error occurred while setting the tool style: \(error)")
      return self.createDefaultErrorAlert(
        message: "An error occurred while setting the tool style",
        exitAppWhenClosed: false)
    }
  }
  ...
  static func createAlertModel(with error: EditorWorker.EditorError) -> AlertModel {
    ...
    case .convertFailed:
      return self.createDefaultErrorAlert(
        message: "An error occurred during the convertion",
        exitAppWhenClosed: false)
    case .addImageFailed:
      return self.createDefaultErrorAlert(
    ...
    case .clearFailed:
      return self.createDefaultErrorAlert(
        message: "An error occurred while clearing the page",
        exitAppWhenClosed: false)
    }
  }
  ...
  static func createAlert(title: String, message: String, exitAppWhenClosed: Bool = true)
    -> AlertModel
  {
